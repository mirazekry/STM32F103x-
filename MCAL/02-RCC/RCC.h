...
extern u8 RCC_u8HSClockCtrl(u8 Copy_u8Clockname,u8 Copy_u8State ,u8 Copy_u8ClockRDY);

/*  Description : This API configure system clock source select                                */
extern u8 RCC_u8ClockSource(u8 Copy_u8Clockname,u8 Copy_u8SysClkState);

/*  Description : This API configure PLL clock select                                          */
extern void RCC_voidPLLSRC(u8 Copy_u8Clockname,u8 Copy_u8MulOrDiv,u8 Copy_u8Operation);

/*  Description : This API configure Enabling nd Disabling Low Speed Clock Source              */
extern u8 RCC_u8LSClockCtrl(u8 Copy_u8Clockname,u8 Copy_u8State ,u8 Copy_u8ClockRDY);
